...
/**
 * Interfaccia per la gestione delle tesi (caricamento e valutazione)
 * e delle prenotazioni alle sedute di laurea.
 */
public interface TesiDAO {
    ...
    boolean haTesiInAttesaDB(String username) throws SQLException;
}