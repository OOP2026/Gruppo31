        ...
        try (Connection conn = ConnessioneDatabase.getInstance().getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    userData.add(rs.getString("matricola") != null ? rs.getString("matricola") : "");
                    userData.add(rs.getString("ssn") != null ? rs.getString("ssn") : "");
                    userData.add(rs.getString("corso_laurea") != null ? rs.getString("corso_laurea") : "");
                    return true;
                }
            }
        }
