...
public class DocenteFrame extends JFrame {
    ...
    public DocenteFrame(Controller controller) {
        ...
        setTitle("Plancia Docente / Relatore");
        setSize(450, 350);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLocationRelativeTo(null);

        // Azione 1: Proposta di un nuovo Tirocinio
        btnAggiungiTirocinio.addActionListener(new ActionListener() {
            @Override
        ...
        // Azione 2: Valutazione di una richiesta di tirocinio ricevevuta
        btnApprovaRichiesta.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        // Azione 3: Approvazione elaborato tesi
        btnApprovaTesi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Studente mockStudente = new Studente("mario99", "123", "mario@stud.it", "Mario", "Rossi", "M001");
